...
export default function Video() {
  ...
  const getData = async () => {
    const options = {
      ...
      headers: {
        'X-RapidAPI-Key': '52a7a10dd6mshad20a38d4ed9821p1554c3jsn52575257e39b',
      ...
      <div id="video_container">
        ...
        <div id="input_container">
          ...
          <button style={{display : display}} onClick={() => {
            setIsDownlodable("loading");
            getData();
          }}>Download</button>
        </div>
        { (isDownlodable == "loading")? <div>loading</div> : <div>{
          (isDownlodable == "false")? <div></div> : <div className="download_information">
          <div id="image"></div>
